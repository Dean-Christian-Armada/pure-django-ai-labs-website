"""
Django settings for ai_labs_website project.
...
SECRET_KEY = '$=syjv22z8o6^2$_5c!)x)mz-t872rysi+hg!1k*8@5s^n9z@_'
...
ROOT_URLCONF = 'ai_labs_website.urls'
...
WSGI_APPLICATION = 'ai_labs_website.wsgi.application'
